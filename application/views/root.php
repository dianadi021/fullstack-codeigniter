...
<head>
	...
	<title><?= $pageTitle ?? 'Fullstack CodeIgniter' ?></title>
	...
	<link rel="stylesheet" media="all" href="<?= base_url('public/assets/scripts/css/app.css') ?>" />
	<link rel="stylesheet" media="all" href="<?= base_url('public/assets/vendor/swiper/swiper-bundle.min.css') ?>" />

	<script src="<?= base_url('public/assets/vendor/jquery/jquery.js') ?>"></script>
	<script src="<?= base_url('public/assets/vendor/jquery/jquery-ui.js') ?>"></script>
	<script src="<?= base_url('public/assets/vendor/jquery/jquery.datetimepicker.full.min.js') ?>"></script>

	<script src="<?= base_url('public/assets/vendor/moment/moment.min.js') ?>"></script>
	<script src="<?= base_url('public/assets/vendor/moment/id.min.js') ?>"></script>

	<script src="<?= base_url('public/assets/vendor/noty/noty.min.js') ?>"></script>
	<script src="<?= base_url('public/assets/vendor/tostr/toastr.min.js') ?>"></script>
	<script src="<?= base_url('public/assets/vendor/font-awesome/all.min.js') ?>"></script>
	<script src="<?= base_url('public/assets/vendor/sweetalert/sweetalert2@11.js') ?>"></script>
	<script src="<?= base_url('public/assets/vendor/swiper/swiper-bundle.min.js') ?>"></script>
	<script src="<?= base_url('public/assets/vendor/listjs/list.min.js') ?>"></script>

	<script src="<?= base_url('public/assets/vendor/datatables/datatables.js') ?>" defer></script>
	<script src="<?= base_url('public/assets/vendor/ag_grid/ag-grid-community.js') ?>" defer></script>
	<script src="<?= base_url('public/assets/vendor/alpinejs/alpinejs@3.14.3.min.js') ?>" defer></script>

	<script src="<?= base_url('public/assets/vendor/tailwindcss/tailwindcss-3.4.5.js') ?>"></script>
	<script src="<?= base_url('public/assets/scripts/js/controller.js') ?>"></script>
</head>

<body class="w-full flex flex-wrap">
	<?php if (valNotEmpty($content)) : $this->load->view($content, $container_data); endif; ?>
